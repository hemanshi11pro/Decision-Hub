...
const CHALLENGES: Record<string, Challenge[]> = {
  daily: [
    ...
    { title: "Ask a Deep Question", desc: "Each evening, take turns asking each other one question from a 'conversation starter' deck or list. Go deeper than 'how was your day'." },
  ],
  weekly: [
    ...
    { title: "Bucket List Date", desc: "Pick one item from your shared bucket list and actually schedule it this week, even if just planning the steps to make it happen." },
    { title: "Role Reversal Day", desc: "For one full day, each of you takes over the other's usual responsibilities around the house. You'll learn to appreciate each other more." },
    { title: "Love Language Experiment", desc: "Spend one full week actively speaking only your partner's love language — whatever they respond to most (words, touch, acts of service, gifts, quality time)." },
    { title: "30-Day Fitness Challenge", desc: "Pick a shared fitness goal (10,000 steps a day, daily yoga, 20 push-ups) and do it together every day for 30 days. Track progress together." },
    { title: "Weekly Check-In Meeting", desc: "Once a week, sit down and do a relationship 'check-in' — what went well, what could be better, one thing you want to do next week." },
  ...
  creative: [
    ...
    { title: "Create a Scrapbook Page", desc: "Together, make one scrapbook page about your relationship using photos, ticket stubs, notes, and drawings. Frame it." },
    ...
    { title: "Paint Something Together", desc: "Buy cheap canvases and paint something simultaneously — the same subject or just whatever feels right. Frame and hang them." },
    ...
    { title: "Write Each Other Letters", desc: "Write a handwritten letter to your partner — seal it and agree not to open it for 6 months, 1 year, or on a milestone occasion." },
    { title: "Choreograph a Dance", desc: "Learn or make up a short dance routine together and perform it — even just for each other. Silly counts." },
    ...
    { title: "Write Your Love Story", desc: "Both of you write the story of how you met and fell in love — independently — then compare. The differences will surprise you." },
  ...
  adventurous: [
    ...
    { title: "Try 5 New Foods in a Week", desc: "Each day of the week, try one food neither of you has eaten before — shop at an international grocery store for inspiration." },
    ...
    { title: "Sleep Under the Stars", desc: "Book a camping trip or set up in your backyard and sleep outside overnight, with no roof between you and the sky." },
    { title: "Say Yes to Everything for 24 Hours", desc: "For one day, say yes to every safe, reasonable suggestion your partner makes — wherever it leads, you both go." },
  ],
  romantic: [
    ...
    { title: "Sunrise Watch Together", desc: "Set an alarm and watch the sunrise together — outside or from a window. Talk about what you're both looking forward to." },
    ...
    { title: "Memory Lane Drive", desc: "Drive together to every place that was meaningful in your relationship — where you first met, first date, first kiss, etc." },
  ...
  silly: [
    ...
    { title: "Dramatic Reading Night", desc: "Take a normal book, article, or Wikipedia page and take turns reading it aloud as dramatically as possible." },
...
export default function CoupleChallengeIdeas() {
  ...
  return (
    <>
      <SEO title="Couple Challenge Ideas - Fun Challenges for Couples" description="Get random couple challenge ideas to strengthen your relationship. Daily habits, creative projects, romantic adventures, and silly fun." canonicalUrl="https://randomtoolbox.replit.app/couple-challenge-ideas" />
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Card className="border-2 shadow-lg">
          <CardContent className="p-8 flex flex-col items-center space-y-6">
              ...
              <AnimatePresence mode="wait">
                {isAnimating ? (
                  ...
                  <motion.div key={`r-${resultKey}`} initial={{ opacity: 0, scale: 0.9, y: 15 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ type: "spring", stiffness: 280, damping: 22 }} className="absolute w-full px-2">
                    <div className="bg-purple-50 dark:bg-purple-950/20 border-2 border-purple-100 dark:border-purple-900/30 rounded-2xl p-6 space-y-3">
                      <h2 className="text-xl font-display font-bold text-purple-600 dark:text-purple-400">{result.title}</h2>
            ...
            <Button size="lg" className="w-full max-w-xs h-16 text-xl rounded-2xl shadow-xl bg-purple-600 hover:bg-purple-700 text-white" onClick={next} disabled={isAnimating} data-testid="button-get-challenge">
